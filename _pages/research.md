...
title: research
permalink: /research/
description: From neural and motor signals to intelligent assistance, stimulation, and embodied action.
nav: true
nav_order: 2
---
...
<div class="card z-depth-0 mb-4">
  <div class="card-body text-center">
    ...
    &nbsp;→&nbsp;
    <span class="font-weight-bold">Intelligent control</span>
    &nbsp;→&nbsp;
    <span class="font-weight-bold">Stimulation or assistive action</span>
  </div>
</div>

## 01 · Neural function restoration and rehabilitation
...
## 02 · Intelligent human–machine interaction
...
## 03 · Brain–computer interfaces and embodied intelligence
  ...
  <div class="col mb-3">
    <div class="card h-100 z-depth-0">
      <div class="card-body">
        ...
        <p>Multimodal representation learning, intent recognition, and intelligent control.</p>
      </div>
    </div>
  </div>
  <div class="col mb-3">
    <div class="card h-100 z-depth-0">
      <div class="card-body">
        <h5 class="font-weight-bold">Deployment</h5>
        <p>Embedded software, clinical validation, and product-oriented translation.</p>
      </div>
    </div>
  </div>
</div>
